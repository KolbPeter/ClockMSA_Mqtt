...
namespace MqttComm
{
    ...
    public interface IMqttService
    {
        ...
        Task<ActionResult<string>> PublishAsync(string topic, string message);

        /// <summary>
        /// Async method to subscribe to the given <paramref name="topic"/> with the given <paramref name="onReceive"/>.
        /// </summary>
        ...
        Task SubscribeAsync(string topic, Action<string> onReceive);

        /// <summary>
        /// Async method to unsubscribe from the given <paramref name="topic"/>. If there are multiple subscription on this topic,
